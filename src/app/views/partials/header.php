...
$renderAppIcon = static function (string $icon): string {
    return match ($icon) {
        ...
        'settings' => '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="m8 16 7.5-7.5 2 2L10 18H8v-2ZM14.75 6.75l1.5-1.5a1.414 1.414 0 1 1 2 2l-1.5 1.5-2-2Z"/><path d="M5 5.75h6M5 12h3M5 18.25h10"/></svg>',
